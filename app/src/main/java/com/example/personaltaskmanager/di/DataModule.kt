...
import com.example.personaltaskmanager.data.repository.SettingRepositoryImpl
...
interface DataModule {
    ...
    @Binds
    fun bindSettingsRepository(settingRepositoryImpl: SettingRepositoryImpl): SettingRepository
